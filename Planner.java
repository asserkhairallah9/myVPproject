...
//JCheckBox = GUI components that can be selected or deslected.
    ...
    public Planner(){
        ...
        // productivityLabel.setBounds(50, 250, 400, 50);
    ...
    private void repaintGUI(){
  	...
  	public static void GetDefault(){            // still 
        numberOfTasks = TaskNumberPanel.getTaskCount();
        SecondPanel.setLayout(new GridLayout(numberOfTasks, 2, 10, 10));
        for(int i = 0; i < numberOfTasks; i++){
            ...
            // taskCheck.setSize(200,30);
            // taskCheck.setPreferredSize(new Dimension(30,30));//(200,30);
