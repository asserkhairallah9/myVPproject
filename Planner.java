...
public class Planner extends JPanel implements ActionListener 
{
  ...
  static JProgressBar Bar;
	...
	private JButton PreviousButton3 = new JButton();
  ...
  public Planner()
  {
    ...
    this.add(SecondPanel);  
	 ...
	 SwitchButton3.setBounds(1200, 650, 160, 100);
	 SwitchButton3.setText("Finish");
	 SwitchButton3.setBackground(Color.WHITE);
	...
	PreviousButton3.setBounds(40, 650, 250, 100);
	 PreviousButton3.setBackground(Color.WHITE);
	 PreviousButton3.setText("Back");
	...
	this.add(SwitchButton3);
	this.add(PreviousButton3);
    ...
    this.add(Bar);
  	...
  	public static void GetDefault(){
		...
		SecondPanel.setLayout(new GridLayout(numberOfTasks, numberOfTasks, 10, 10));
  ...
  private static void updateProgressBar()   /// update
  {
	 int Done = 0;
